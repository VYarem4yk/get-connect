export let store = {
  ...
  addPost() {
    let newPost = {
      id: "5",
      postText: this.state.profilePage.curentPostText,
      likes: "0",
    };
    this.state.profilePage.PostData.unshift(newPost);
    this.state.profilePage.curentPostText = "";
    rerenderEntireTree(this.state);
  },

  textPostChange(newText) {
    this.state.profilePage.curentPostText = newText;
